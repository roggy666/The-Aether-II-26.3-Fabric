...
public record PointedStoneConfiguration(BlockStateProvider stoneBlock, BlockStateProvider pointedStoneBlock, float chanceOfTallerDripstone, float chanceOfDirectionalSpread, float chanceOfSpreadRadius2, float chanceOfSpreadRadius3) {
    public static final MapCodec<PointedStoneConfiguration> CODEC = RecordCodecBuilder.mapCodec((p_191286_) -> p_191286_.group(
            BlockStateProvider.DIRECT_CODEC.fieldOf("stone_block").forGetter(PointedStoneConfiguration::stoneBlock),
            BlockStateProvider.DIRECT_CODEC.fieldOf("pointed_stone_block").forGetter(PointedStoneConfiguration::pointedStoneBlock),
