...
public record ArcticIceSpikeConfiguration(BlockStateProvider block, float baseRadius, int additionalRadius, float baseSlopeIntensity, int additionalSlopeIntensity, TagKey<Block> validBlocks) {
    public static final MapCodec<ArcticIceSpikeConfiguration> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(
            BlockStateProvider.DIRECT_CODEC.fieldOf("block").forGetter(ArcticIceSpikeConfiguration::block),
