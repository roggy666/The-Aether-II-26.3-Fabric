...
public record FallenLogConfiguration(BlockStateProvider block, IntProvider length, Optional<Holder<PlacedFeature>> vegetationFeature, float vegetationChance, TagKey<Block> validBlocks) {
    public static final MapCodec<FallenLogConfiguration> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(
            BlockStateProvider.DIRECT_CODEC.fieldOf("block").forGetter(FallenLogConfiguration::block),
