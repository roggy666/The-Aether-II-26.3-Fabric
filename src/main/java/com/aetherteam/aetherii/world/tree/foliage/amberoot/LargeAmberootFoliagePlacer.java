...
public class LargeAmberootFoliagePlacer extends AbstractBranchedFoliagePlacer {
    ...
    public void placeTreeHalf(WorldGenLevel level, FoliageSetter foliageSetter, RandomSource random, TreeFeature config, FoliageAttachment attachment, int factorX, int factorZ, int i, Direction.Axis axis) {
        BlockPos pos = attachment.pos();
        int x = pos.getX();
        int y = pos.getY();
        int z = pos.getZ();
