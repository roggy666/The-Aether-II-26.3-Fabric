...
public class AmberootFoliagePlacer extends FoliagePlacer {
    ...
    @Override
    protected void createFoliage(WorldGenLevel level, FoliageSetter foliageSetter, RandomSource random, TreeFeature config, int maxHeight, FoliageAttachment attachment, int height, int radius, int offset) {
    ...
    protected void placeLeavesRow(WorldGenLevel level, FoliageSetter setter, RandomSource random, TreeFeature config, BlockPos pos, int radius, int y, boolean large) {
    ...
    @Override
    public int foliageHeight(RandomSource rand, int pHeight, TreeFeature config) {
        return 0;
    }
