...
public class ArilumShootBlock extends Block  implements LiquidBlockContainer, BonemealableBlock {
    ...
    @Override
    public boolean canPlaceLiquid(@org.jetbrains.annotations.Nullable LivingEntity livingEntity, BlockGetter blockGetter, BlockPos blockPos, BlockState blockState, Fluid fluid) {
        return false;
    }
