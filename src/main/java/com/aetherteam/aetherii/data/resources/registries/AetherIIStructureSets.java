...
public class AetherIIStructureSets {
    ...
    /**
     * Warning for "deprecation" is suppressed because using {@link AbstractSpreadingStructurePlacement.ExclusionZone} is necessary.
     */
    ...
    public static void bootstrap(BootstrapContext<StructureSet> context) {
        ...
        context.register(ANIMAL_DENS, new StructureSet(List.of(
                ...
                new RandomSpreadStructurePlacement(Vec3i.ZERO, AbstractSpreadingStructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_1, 1.0F, 4027017, Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(outposts, 6)), 8, 5, RandomSpreadType.LINEAR))
        );
        ...
        context.register(AETHER_SURFACE_STRUCTURES, new StructureSet(List.of(
                ...
                new RandomSpreadStructurePlacement(Vec3i.ZERO, AbstractSpreadingStructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_1, 1.0F, 1147092, Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(outposts, 8)), 18, 8, RandomSpreadType.LINEAR))
        );
        ...
        context.register(AETHER_SURFACE_RUINS, new StructureSet(List.of(
                ...
                new RandomSpreadStructurePlacement(Vec3i.ZERO, AbstractSpreadingStructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_2, 0.75F, 2038911, Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(outposts, 6)), 14, 8, RandomSpreadType.LINEAR))
        );
        ...
        context.register(AETHER_UNDERGROUND_RUINS, new StructureSet(List.of(
                ...
                new RandomSpreadStructurePlacement(Vec3i.ZERO, AbstractSpreadingStructurePlacement.FrequencyReductionMethod.DEFAULT, 1.0F, 7881032, Optional.empty(), 4, 2, RandomSpreadType.LINEAR))
        );
        ...
        context.register(AQUEDUCTS, new StructureSet(List.of(
                ...
                new RandomSpreadStructurePlacement(Vec3i.ZERO, AbstractSpreadingStructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_2, 1.0F, 2038911, Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(outposts, 6)), 10, 5, RandomSpreadType.LINEAR))
        );
        ...
        Holder.Reference<StructureSet> sentryRuins = context.register(AETHER_UNDERGROUND_COMPLEXES, new StructureSet(List.of(
                ...
                new RandomSpreadStructurePlacement(Vec3i.ZERO, AbstractSpreadingStructurePlacement.FrequencyReductionMethod.DEFAULT, 1.0F, 32146754, Optional.empty(), 12, 6, RandomSpreadType.TRIANGULAR))
        );
        ...
        context.register(IRRADIATED_REMNANTS, new StructureSet(List.of(
                ...
                new RandomSpreadStructurePlacement(Vec3i.ZERO, AbstractSpreadingStructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_1, 1.0F, 833294, Optional.of(new AbstractSpreadingStructurePlacement.ExclusionZone(sentryRuins, 4)), 8, 3, RandomSpreadType.LINEAR))
        );
    }
}