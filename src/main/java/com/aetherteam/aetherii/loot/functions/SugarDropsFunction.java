...
public class SugarDropsFunction  extends LootItemConditionalFunction {
    public static final MapCodec<SugarDropsFunction> CODEC = RecordCodecBuilder.mapCodec((instance) -> commonFields(instance)
    ...
    private SugarDropsFunction(Optional<Holder<LootItemCondition>> conditions, Holder<ContextIntProvider> value) {
        super(conditions);
        this.value = value;
    }
