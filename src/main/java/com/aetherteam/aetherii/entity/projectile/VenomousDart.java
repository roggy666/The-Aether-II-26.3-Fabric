...
public class VenomousDart extends AbstractArrow {
    ...
    public VenomousDart(double x, double y, double z, Level level) {
        super(AetherIIEntityTypes.VENOMOUS_DART, x, y, z, level, new ItemStack(Items.ARROW), null);
        this.pickup = Pickup.DISALLOWED;
        this.setBaseDamage(1.0F);
    }

    public VenomousDart(LivingEntity owner, Level level) {
        super(AetherIIEntityTypes.VENOMOUS_DART, owner, level, new ItemStack(Items.ARROW), null);
        this.pickup = Pickup.DISALLOWED;
        this.setBaseDamage(1.0F);
    }
    ...
    protected void doPostHurtEffects(LivingEntity living) {
        ...
        living.getAttachedOrCreate(AetherIIDataAttachments.EFFECTS_SYSTEM).addBuildup(living, this, this.getOwner(), EffectBuildupPresets.VENOM, 300);
