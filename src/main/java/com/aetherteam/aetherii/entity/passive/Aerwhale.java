...
public class Aerwhale extends PathfinderMob {
    ...
    protected SoundEvent getAmbientSound() {
        return AetherIISoundEvents.ENTITY_AERWHALE_AMBIENT;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return AetherIISoundEvents.ENTITY_AERWHALE_HURT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return AetherIISoundEvents.ENTITY_AERWHALE_DEATH;
    }
    ...
    public static class AerwhaleMoveControl extends MoveControl {
        ...
        private boolean canReach(Vec3 delta) {
            AABB aabb = this.whale.getBoundingBox();
