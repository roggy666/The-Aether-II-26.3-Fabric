...
//        x += 43;
//        this.addRenderableWidget(new SectionTab(this, this.explorationSection, x, y, 42, 19, Identifier.fromNamespaceAndPath(AetherII.MODID, "guidebook/icon_exploration"))); // TODO WIP ALPHA THINGS
