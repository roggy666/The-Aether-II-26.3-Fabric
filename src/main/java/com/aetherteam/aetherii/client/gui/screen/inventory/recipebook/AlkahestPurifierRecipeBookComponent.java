...
public class AlkahestPurifierRecipeBookComponent extends RecipeBookComponent<AlkahestPurifierMenu> {
    private static final WidgetSprites FILTER_SPRITES = new WidgetSprites(
            Identifier.fromNamespaceAndPath(AetherII.MODID, "recipe_book/purifier_filter_enabled"),
            Identifier.fromNamespaceAndPath(AetherII.MODID, "recipe_book/purifier_filter_disabled"),
            Identifier.fromNamespaceAndPath(AetherII.MODID, "recipe_book/purifier_filter_enabled_highlighted"),
            Identifier.fromNamespaceAndPath(AetherII.MODID, "recipe_book/purifier_filter_disabled_highlighted"));
